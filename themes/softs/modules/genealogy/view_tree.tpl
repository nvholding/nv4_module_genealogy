...
<!--  <div title="Giới hạn cấp xem" class="btn_ctrl_svg1" style="border: 0px;  bottom: 60px; left: 15px; background-color: transparent ">
    <select name="" id="set_limit" style=" background-color: white; border-color: #ddd ; color: grey;  ; border-radius: 5px; padding: 4px 3px; max-width: 240px; font-size: small">
        <option value="">-Cấu hình giới hạn xem cấp gia phả</option>
