 ...
 * @Createdate Thu, 22 Feb 2024 05:52:07 GMT
 */
...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_131";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_210";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_211";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_212";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_213";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_214";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_215";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_216";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_217";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_218";
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "(
  ...
  col_fix varchar(250) DEFAULT '',
  PRIMARY KEY (id),
  UNIQUE KEY gid (gid,alias),
  KEY parentid (parentid)
) ENGINE=MyISAM";

$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_131(
  ...
  homeimgbg varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_210(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_211(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_212(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_213(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_214(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_215(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_216(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_217(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_218(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  fid smallint(5) unsigned NOT NULL DEFAULT 0,
  listfid varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  admin_id mediumint(8) unsigned NOT NULL DEFAULT 0,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_block_cat(
  ...
  subcatid text COLLATE utf8mb4_unicode_ci NOT NULL,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_genealogy(
  ...
  hometext text COLLATE utf8mb4_unicode_ci NOT NULL,
  homeimgfile varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT '',
  homeimgbg varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT '',
  homeimgalt varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT '',
  homeimgthumb tinyint(4) NOT NULL DEFAULT 0,
  inhome tinyint(1) unsigned NOT NULL DEFAULT 0,
  allowed_comm varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  email varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  who_view int(11) NOT NULL DEFAULT 0,
  king_icon int(11) NOT NULL DEFAULT 0,
  cityid smallint(5) unsigned NOT NULL DEFAULT 0,
  districtid smallint(5) unsigned NOT NULL DEFAULT 0,
  wardid smallint(5) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (id),
