...
class Location
{
    ...
    public function getArrayCountry($inArrayId = array())
    {
        ...
        $sql = 'SELECT * FROM ' . $db_config['dbsystem'] . '.' . NV_PREFIXLANG . '_' . $module_name . '_country WHERE status=1 ' . $where . ' ORDER BY weight ASC';
    ...
    public function getArrayProvince($inArrayId = array(), $countryid = 0)
    {
        ...
        $sql = 'SELECT * FROM ' . $db_config['dbsystem'] . '.' . NV_PREFIXLANG . '_' . $module_name . '_province WHERE status=1 ' . $where . ' ORDER BY weight ASC';
    ...
    public function getArrayDistrict($inArrayId = array(), $provinceid = 0)
    {
        ...
        $sql = 'SELECT * FROM ' . $db_config['dbsystem'] . '.' . NV_PREFIXLANG . '_' . $module_name . '_district WHERE status=1 ' . $where . ' ORDER BY weight ASC';
    ...
    public function getArrayWard($inArrayId = array(), $districtid = 0)
    {
        ...
        $sql = 'SELECT * FROM ' . $db_config['dbsystem'] . '.' . NV_PREFIXLANG . '_' . $module_name . '_ward WHERE status=1 ' . $where . ' ORDER BY title ASC';
